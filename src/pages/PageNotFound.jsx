      ...
      {isMounted && (
        <div className="not-found-content bg-white dark:bg-gray-700 shadow-md rounded-lg p-8 mx-auto flex flex-col items-center">
          ...
          <div className="mt-8 flex gap-3 justify-around">
            <button
              className="relative  text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
