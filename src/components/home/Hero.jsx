...
export default function Hero() {
  ...
  <center>
    ...
    <span className='text-[78px] text-black font-bold '>The all in one solution for</span><br/> <TypeAnimation
      ...
      repeat={Infinity}
    />
    <p className='my-8 w-[700px] font-semibold bg-gray-200 p-3 border-2 border-gray-300 shadow-lg rounded-full text-xl text-black'>Any question. Any subject. Get instant, step-by-step solutions </p>
    <Link to="/signin">
