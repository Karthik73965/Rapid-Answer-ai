...
export default function Feautures() {
    return (
        <>
            <main className='m-8 mb-20 fotter    rounded-xl p-10    mt-20 '>
                <h3 className='text-4xl font-bold text-slate-900 flex justify-center text align-middle'>Feautures that will make your study more productive </h3>
                ...
                <section className='flex justify-around align-middle px-10 py-5 m-8 border-4 border-blue-400  rounded-3xl'>
                    ...
                    <ul className='p-3'>
                        ...
                        <li className='m-5 font-semibold font-slate-600 text-xl   '><div className='flex align-middle justify-center'><MdFileDownloadDone className='text-green-600 m-1 mr-2' size={30} /> these are feautures so that we can stand out in our life</div></li>
                        <center>
                            <button type="button" className="relative text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl mt-4 focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center ring-animation">
